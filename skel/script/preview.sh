...
confs['db/basic']='{
    "debug_sql": true,
    "driver_name": "cdbpool",
    "data_source": "tcp(PREVIEW_HOST:9123)/default?timeout=5s&readTimeout=4s&writeTimeout=15s&enableCircuitBreaker=true"
}'
confs['db/pools']='{
    "max_idle_conns": 20,
    "max_open_conns": 100,
