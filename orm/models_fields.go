...
const (
	IsIntegerField         = TypeBitField | TypeSmallIntegerField | TypeIntegerField | TypeBigIntegerField | TypePositiveBitField | TypePositiveSmallIntegerField | TypePositiveIntegerField | TypePositiveBigIntegerField
	IsPositiveIntegerField = TypePositiveBitField | TypePositiveSmallIntegerField | TypePositiveIntegerField | TypePositiveBigIntegerField
	IsFieldType            = TypeMax - 1
)
