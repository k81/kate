...
func (o querySet) Limit(rowCount interface{}, args ...interface{}) QuerySeter {
	o.limit = ToInt64(rowCount)
	if len(args) > 0 {
		o.setOffset(args[0])
	}
	return &o
...
func (o *querySet) All(container interface{}, cols ...string) (int64, error) {
	...
	return o.orm.alias.DbBaser.ReadBatch(o.orm.db, o, o.mi, o.cond, container, o.orm.alias.TZ, cols, o.forUpdate)
}
...
func (o *querySet) One(container interface{}, cols ...string) error {
	...
	num, err := o.orm.alias.DbBaser.ReadBatch(o.orm.db, o, o.mi, o.cond, container, o.orm.alias.TZ, cols, o.forUpdate)
	if err != nil {
		return err
	}
	if num == 0 {
